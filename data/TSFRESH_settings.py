        ...
        name_to_param.update(
            {
                ...
                "recurrence_analysis5": [
                    {"rqameasure5": s} for s in ["DET","avgDL","maxDL","Sdiag","LAM","avgVL","maxVL","Svert","avgWVL","maxWVL","Swhite","tauRR","LAC_short","LAC_long"]
                ],
                "recurrence_analysis10": [
                    {"rqameasure10": s} for s in ["DET","avgDL","maxDL","Sdiag","LAM","avgVL","maxVL","Svert","avgWVL","maxWVL","Swhite","tauRR","LAC_short","LAC_long"]
                ],
                "recurrence_analysis20": [
                    {"rqameasure20": s} for s in ["DET","avgDL","maxDL","Sdiag","LAM","avgVL","maxVL","Svert","avgWVL","maxWVL","Swhite","tauRR","LAC_short","LAC_long"]
                ],
                
                "recurrence_network_analysis": [
                    {"rnameasure": s} for s in ["assort","transi","diam"]
                ],
                
                # "recurrence_analysis": [
                #     {"rqa_measure": s} for s in ["EPS","DET","avgDL","maxDL","LAM","avgVL","maxVL","avgWVL","maxWVL","tauRR"]
                # ],
                #
            }
